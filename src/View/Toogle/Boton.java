...
import View.Sombra.Renderizador;

public class Boton extends JComponent {
    ...
    public void addEventToggleSelected(Listener event) {
    ...
    private void init() {
        ...
        setForeground(new Color(14, 2, 26));
    ...
    private BufferedImage createShadow(int size) {
        ...
        g2.dispose();
        return new Renderizador(5, 0.5f, new Color(50, 50, 50)).createShadow(img);
    }
}
