...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Dashboard"},
        {"~Área Disciplinaria~"},
        {"Gestion Disciplinaria","Códigos Asignados","Códigos Disciplinarios","Tipos de Códigos","Observaciones","Solicitudes Permisos","Asistencias/Inasistencias"},
        {"Avisos"},
        {"Rango de Horas"},
        {"~Extras~"},
        {"Visitas Enfermeria"},
        {"Salones", "Salones", "Salones Reservados"},
        {"~Adicionales~"},
        {"Credenciales"},
        {"Cerrar Sesión"}
    };
