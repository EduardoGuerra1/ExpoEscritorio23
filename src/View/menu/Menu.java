...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Dashboard"},
        {"~Área Disciplinaria~"},
        {"Gestion Disciplinaria","Códigos Asignados","Códigos Disciplinarios","Tipos de Códigos","Estudiantes","Observaciones","Solicitudes Permisos","Asistencias/Inasistencias"},
        {"Avisos"},
        {"Horarios "},
        {"~Extras~"},
        {"Visitas Enfermeria"},
