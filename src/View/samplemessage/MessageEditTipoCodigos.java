...
public class MessageEditTipoCodigos extends javax.swing.JPanel {
    ...
    public void actualizarDatosHaciaApi() {
        ...
        try {
            ...
            jsonData.put("idTipoCodigoConductual", id);
            jsonData.put("tipoCodigoConductual", codigoConductual);

            // Llamar al método putApiAsync para enviar los datos de actualización
            String endpointUrl = "https://expo2023-6f28ab340676.herokuapp.com/TiposCodigosConductuales/update"; // Reemplaza esto con la URL de tu API
